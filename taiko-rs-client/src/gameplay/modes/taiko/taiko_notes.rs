...
impl TaikoNote {
    pub fn new(time:u64, hit_type:HitType, finisher:bool, speed:f64) -> Self {
        Self {
            time, 
            hit_time: 0,
            hit_type, 
...
impl TaikoSlider {
    pub fn new(time:u64, end_time:u64, finisher:bool, speed:f64) -> Self {
...
impl TaikoSpinner {
    pub fn new(time:u64, end_time:u64, speed:f64, hits_required:u16) -> Self {
        Self {
            time, 
            end_time,
            speed,
